...
export class ServiceWorkerOriginTrialFeature extends jspb.Message {
    ...
    static toObject(
        ...
        msg: ServiceWorkerOriginTrialFeature,
    ): ServiceWorkerOriginTrialFeature.AsObject;
...
export class ServiceWorkerOriginTrialInfo extends jspb.Message {
    ...
    addFeatures(
        value?: ServiceWorkerOriginTrialFeature,
        index?: number,
    ): ServiceWorkerOriginTrialFeature;
    ...
    static toObject(
        includeInstance: boolean,
        msg: ServiceWorkerOriginTrialInfo,
    ): ServiceWorkerOriginTrialInfo.AsObject;
...
export class ServiceWorkerNavigationPreloadState extends jspb.Message {
    ...
    static toObject(
        includeInstance: boolean,
        msg: ServiceWorkerNavigationPreloadState,
    ): ServiceWorkerNavigationPreloadState.AsObject;
...
export class ServiceWorkerRegistrationData extends jspb.Message {
    ...
    getUpdateViaCache():
        | ServiceWorkerRegistrationData.ServiceWorkerUpdateViaCacheTypeMap[keyof ServiceWorkerRegistrationData.ServiceWorkerUpdateViaCacheTypeMap]
        | undefined;

    setUpdateViaCache(
        value: ServiceWorkerRegistrationData.ServiceWorkerUpdateViaCacheTypeMap[keyof ServiceWorkerRegistrationData.ServiceWorkerUpdateViaCacheTypeMap],
    ): void;
    ...
    getScriptType():
        | ServiceWorkerRegistrationData.ServiceWorkerScriptTypeMap[keyof ServiceWorkerRegistrationData.ServiceWorkerScriptTypeMap]
        | undefined;

    setScriptType(
        value: ServiceWorkerRegistrationData.ServiceWorkerScriptTypeMap[keyof ServiceWorkerRegistrationData.ServiceWorkerScriptTypeMap],
    ): void;
    ...
    getCrossOriginEmbedderPolicyValue():
        | ServiceWorkerRegistrationData.CrossOriginEmbedderPolicyValueMap[keyof ServiceWorkerRegistrationData.CrossOriginEmbedderPolicyValueMap]
        | undefined;

    setCrossOriginEmbedderPolicyValue(
        value: ServiceWorkerRegistrationData.CrossOriginEmbedderPolicyValueMap[keyof ServiceWorkerRegistrationData.CrossOriginEmbedderPolicyValueMap],
    ): void;
    ...
    getCrossOriginEmbedderPolicyReportOnlyValue():
        | ServiceWorkerRegistrationData.CrossOriginEmbedderPolicyValueMap[keyof ServiceWorkerRegistrationData.CrossOriginEmbedderPolicyValueMap]
        | undefined;

    setCrossOriginEmbedderPolicyReportOnlyValue(
        value: ServiceWorkerRegistrationData.CrossOriginEmbedderPolicyValueMap[keyof ServiceWorkerRegistrationData.CrossOriginEmbedderPolicyValueMap],
    ): void;
    ...
    static toObject(
        includeInstance: boolean,
        msg: ServiceWorkerRegistrationData,
    ): ServiceWorkerRegistrationData.AsObject;
...
export class ServiceWorkerResourceRecord extends jspb.Message {
    ...
    static toObject(
        includeInstance: boolean,
        msg: ServiceWorkerResourceRecord,
    ): ServiceWorkerResourceRecord.AsObject;
