...
export class SwRegistrationHandler {
    ...
    constructor(dbPath: string){
        ...
        this.db = new Level(dbPath, { keyEncoding:"binary", valueEncoding:"binary", writeBufferSize:524288 }) 
    }
    ...
    async saveRegistrationEntries(...entries: IndexDbRecord<ServiceWorkerRegistrationData | ServiceWorkerResourceRecord>[]) {
