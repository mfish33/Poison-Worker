...
export class PickleWriter {
    ...
    writeBoolean(bool : boolean) {
        this.modify(
            1,
            () => this.internalBuffer.writeUint8(Number(bool), this.pointer)
        )
    }
    ...
    writeUInt16(num: number) {
        this.modify(
            2,
            () => this.internalBuffer.writeUint16LE(num, this.pointer)
        )
    }
    ...
    writeInt(num: number) {
        this.modify(
            4,
            () => this.internalBuffer.writeInt32LE(num, this.pointer)
        )
    }
    ...
    writeUInt32(num: number) {
        this.modify(
            4,
            () => this.internalBuffer.writeUint32LE(num, this.pointer)
        )
    }
    ...
    writeInt64(num: bigint) {
        this.modify(
            8,
            () => this.internalBuffer.writeBigInt64LE(num, this.pointer)
        )
    }
    ...
    writeUInt64(num: bigint) {
        this.modify(
            8,
            () => this.internalBuffer.writeBigUInt64LE(num, this.pointer)
        )
    }
    ...
    writeFloat(num: number) {
        this.modify(
            4,
            () => this.internalBuffer.writeFloatLE(num, this.pointer)
        )
    }
    ...
    writeDouble(num: number) {
        this.modify(
            8,
            () => this.internalBuffer.writeDoubleLE(num, this.pointer)
        )
    }
    ...
    writeData(buf: Buffer) {
        ...
        this.modify(
            buf.length,
            () => buf.copy(this.internalBuffer, this.pointer)
        )
    }
